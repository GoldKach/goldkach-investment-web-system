...
export default async function PortfolioPage() {
  ...
  // ✅ Guard against undefined/null before calling .filter()
  const userPortfolios = Array.isArray(portfolios.data)
    ? portfolios.data.filter((portfolio) => portfolio.userId === userId)
    : [];
