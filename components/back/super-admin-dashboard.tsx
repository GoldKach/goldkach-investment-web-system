          ...
          {kpiData.map((kpi, index) => (
            <Card key={index} className="bg-white dark:bg-slate-900 border-gray-200 dark:border-slate-800">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-gray-600 dark:text-slate-400">{kpi.title}</CardTitle>
                <kpi.icon className="h-4 w-4 text-gray-400 dark:text-slate-500" />
              </CardHeader>
              <CardContent>
