...
export function RegisterForm() {
  ...
  // Handler: when user checks the TOS checkbox inside dialog, accept and close immediately
  ...
  // Handler: when user checks the Privacy checkbox inside dialog, accept and close immediately
